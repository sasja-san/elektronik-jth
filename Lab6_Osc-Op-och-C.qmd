...
:::{.column-margin}
![](img6/Smitt_hysteresis_graph.svg){width=70mm}
:::
...
Först låt oss se det ideala sättet att överföra en signal på.
...
En bra *heuristik*[En heuristik är en användbar approximation. Den brukar inte vara 100% sann, men för någon som är ny till ett ämne så kan den vara till mycket stor nytta. Du har kanske fått använda "elektronskal" som en heuristik när du studerat kemi?]{.aside} är att
